...
* Jacoco skip kotlin generated code, see https://github.com/jacoco/jacoco/issues/552. Possible once https://youtrack.jetbrains.com/issueMobile/KT-18383 is fixed
